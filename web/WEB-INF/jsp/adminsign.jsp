    ...
    <div class="mt-20">
        <table
            ...
            <c:forEach items="${signlist }" var="signinfo">
                <tr class="text-c">
                    <td>${signinfo.tManualsignId}</td>
                    <td>${signinfo.tUserinfo.tUserinfoName}</td>
                    <td><fmt:formatDate value="${signinfo.tManualsignTime }" type="both"/></td>
                    <td>${signinfo.tManualsignDesc }</td>
                    <td>${signinfo.tManualsignTag }</td>
