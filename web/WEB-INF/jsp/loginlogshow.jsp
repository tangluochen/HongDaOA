		...
		<div class="mt-20">
			<table
				...
				<tbody>
					...
					<c:forEach items="${loginloglist }" var="login">
						<tr class="text-c">
							<td><input type="checkbox" value="1" name=""></td>
							<td>${login.tLoginlogId }</td>
							<td>${login.tLoginlogTime }</td>
							<td>${login.tLoginlogUserip }</td>
							<td>${login.tUserinfo.tUserinfoName }</td>
							<td class="td-manage"> <a
								title="删除" href="logdelete.do?id=${login.tLoginlogId }"
