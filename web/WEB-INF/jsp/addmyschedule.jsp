...
<body>
	...
	<form class="form form-horizontal" id="form-article-add"
				...
				<span class="select-box">
					...
					style="appearance: none; -moz-appearance: none; -webkit-appearance: none; -ms-appearance: none;">
						<c:forEach items="${meetingList}" var="meeting">
							<option value="${meeting.tMeetinginfoId}">${meeting.tMeetinginfoName}</option>
						</c:forEach>
					</select>
				</span>
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${sessionScope.TUserinfo.tUserinfoName }" readonly="readonly"
					id="createuser" name="tScheduleCreateuser">
			</div>
		</div>
<%--		<div class="row cl">--%>
<%--			<label class="form-label col-xs-4 col-sm-2"><span--%>
