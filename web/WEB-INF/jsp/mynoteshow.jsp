				...
				<tbody>
					...
					<c:forEach items="${mynotelist }" var="mynote">
						<tr class="text-c">
							...
							<td>${mynote.tMynoteId }</td>
							<td>${mynote.tMynoteTitle }</td>
							<td>${mynote.tMynoteContent }</td>
							<td>${mynote.tMynoteCreatetime }</td>
							<td>${mynote.tMynoteCreateuser }</td>
							<td class="td-manage"><a style="text-decoration: none"
								onClick="member_stop(this,'10001')" href="javascript:;"
								title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a
								title="编辑"
								href="mynoteupdate1.do?tMynoteId=${mynote.tMynoteId }
								&tMynoteTitle=${mynote.tMynoteTitle }
								&tMynoteContent=${mynote.tMynoteContent }&tMynoteCreateuser=${mynote.tMynoteCreateuser } "
								onclick="member_edit('编辑','member-add.html','4','','510')"
								class="ml-5" style="text-decoration: none"><i
									class="Hui-iconfont">&#xe6df;</i></a> <a title="删除"
								href="mynotedelete.do?id=${mynote.tMynoteId }"
