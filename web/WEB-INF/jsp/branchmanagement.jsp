...
<body>
	...
	<div class="page-container">
		<form action="searchBranch.do" method="post" >
			<div class="text-c">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="#" onclick="alldelete();return false"
				...
				<a href="addbranch.do" class="btn btn-primary radius"><i
					class="Hui-iconfont">&#xe600;</i> 添加机构</a></span> <span class="r">共有数据：<strong>${page.totalCount }</strong>
				条
			</span>
		</div>
				...
				<c:forEach items="${branchmanagement}" var="branchs">
					<tr class="text-c">
						<td><input type="checkbox"
							value="${branchs.tBranchinfoId }" name="checkid" id="checkid"></td>
						<td>${branchs.tBranchinfoId }</td>
						<td>${branchs.tBranchinfoName}</td>
						<td>${branchs.tBranchinfoShortname}</td>
						<%
						...
						<td class="td-manage"><a style="text-decoration: none"
							...
							href="updatebranch.do?id=${branchs.tBranchinfoId }&name=${branchs.tBranchinfoName }&shortname=${branchs.tBranchinfoShortname }"
							onclick="updatebranch(id,name,shortname)" class="ml-5"
							style="text-decoration: none"><i class="Hui-iconfont">&#xe6df;</i></a>
							<a title="删除"
							href="DeleteBranch.do?branchid=${branchs.tBranchinfoId }"
