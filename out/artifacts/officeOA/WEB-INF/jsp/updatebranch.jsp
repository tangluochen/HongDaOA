	...
	<form class="form form-horizontal" id="form-admin-add"
		...
		<div class="row cl">
			...
			<input type="hidden" value="${id}"
				...
				<input type="text" class="input-text" value="${id}"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" autocomplete="on" value="${name} "
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" autocomplete="on" value="${shortname}"
