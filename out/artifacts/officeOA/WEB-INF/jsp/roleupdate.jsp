	...
	<form class="form form-horizontal" id="form-admin-add"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${userBean.tUserinfoName}" placeholder=""
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<select name="role" id="role">
					<c:if test="${userBean.tRoleinfo.tRoleinfoId==1}">
					...
					<c:if test="${userBean.tRoleinfo.tRoleinfoId==2}">
						<option value="1" >
							系统管理员
						</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<select name="state" id="state">
					<c:if test="${userBean.tUserstate.tUserstateId==1}">
						<option value="1" selected>
							正常状态
						</option>
						<option value="0">
					...
					<c:if test="${userBean.tUserstate.tUserstateId==0}">
						<option value="1">
							正常状态
						</option>
