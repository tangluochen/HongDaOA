...
<body>
	...
	<form class="form form-horizontal" id="form-article-add"
		action="mynoteupdate.do" method="post">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<%=request.getParameter("title") %>" placeholder=""
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" onfocus=this.blur() value="<%=request.getParameter("createuser") %>" placeholder=""
					id="mynotecreateuser" name="mynotecreateuser">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">便签内容：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<!--  <script id="editor" name= "editor" type="text/plain" style="width:100%;height:400px;"></script> -->
				<input type="text" class="input-text" value="<%=request.getParameter("content") %>" placeholder=""
