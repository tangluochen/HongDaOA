...
<![endif]-->
<title>宏达OA管理系统-0.0.1.070609_Alpha</title>
<meta name="keywords"
	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl">
			<a class="logo navbar-logo f-l mr-10 hidden-xs"
				href="/aboutHui.shtml">宏达OA管理系统</a> <a
				class="logo navbar-logo-m f-l mr-10 visible-xs"
				href="/aboutHui.shtml">H-ui</a> <span
				class="logo navbar-slogan f-l mr-10 hidden-xs">0.0.1.070609_Alpha</span> <a
			...
			<div id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs" align="left" >
				<jsp:include page="publishPage.jsp"></jsp:include></div>
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li>用户:</li>
				<li class="dropDown dropDown_hover"><a href="#"
					class="dropDown_A">${TUserinfo.tUserinfoName} <i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
				...
				<dd>
					<ul>
						<c:forEach items="${map.value}" var="list">
							<li><a data-href="${list.tPowerUri}"
								data-title="${list.tPowerName}" href="javascript:void(0)">${list.tPowerName}</a></li>
						</c:forEach>
					</ul>
				</dd>
			</c:forEach>
