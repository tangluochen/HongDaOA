...
<nav class="breadcrumb"> <i class="Hui-iconfont">&#xe67f;</i> 首页
	...
	<!--            
              CONTENT 
                        ...
                        <br>
	<br>
	<form action="addscheduleob.do" method="post" id="lcform">
		<div id="content" class="white">
			<div class="text-c">
				日程列表:<span class="select-box inline">
				<select name="scheduleId" onchange="if(confirm('是否提交'))document.getElementById('lcform').submit()"
					id="scheduleId" class="select">
						<option value="0">--选择日程--</option>
						<c:forEach items="${schedulelist}" var="schedule">
							<option value="${schedule.tScheduleId}">${schedule.tScheduleTitle}
							</option>
						</c:forEach>
				</select>
