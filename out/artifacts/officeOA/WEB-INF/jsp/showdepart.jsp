	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray">
			<span class="l"> <a href="javascript:;" id="datadel"
				...
				onclick="admin_role_add('添加部门','adddepart.do','800')"><i
		...
		<table class="table table-border table-bordered table-hover table-bg">
			...
			<tbody>
				...
				<c:forEach items="${listDepartPojo}" var="list">
					<tr class="text-c">
						<td><input type="checkbox" value="${list.tDepartinfoId}"
							name="items"></td>
						<td>${list.tDepartinfoId}</td>
						<td>${list.tDepartinfoName}</td>
						<td>${list.tBranchinfo.tBranchinfoName}</td>
						<td>${list.tUserinfo.tUserinfoId}</td>
						<td>${list.tDepartinfoTel}</td>
						<td>${list.tDepartinfoMobiletel}</td>
						<td>${list.tDepartinfoFaxes}</td>
						<td class="f-14"><a title="编辑" href="javascript:;"
							onclick="admin_role_edit('部门编辑','updatedepart.do?id=${list.tDepartinfoId}','4')"
							style="text-decoration: none"><i class="Hui-iconfont">&#xe6df;</i></a>
							<a title="删除" href="javascript:;" id="${list.tDepartinfoId}"
