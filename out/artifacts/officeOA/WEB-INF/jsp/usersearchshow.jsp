	...
	<form action="usersearch.do">
		<div class="text-c">
			...
			搜索条件： <input type="text" class="input-text" style="width: 250px"
						 placeholder="输入用户名" id="username1" name="username1" value="${username1}">
		...
		<div class="mt-20">
			<table
				...
				<div align="center">
					...
					${page.pageNow} 页</font> <a href="usersearch.do?pageNow=1&username1=${username1}">首页</a>
					<c:choose>
						<c:when test="${page.pageNow - 1 > 0}">
							<a href="usersearch.do?pageNow=${page.pageNow - 1}&username1=${username1}">上一页</a>
						</c:when>
						<c:when test="${page.pageNow - 1 <= 0}">
							<a href="usersearch.do?pageNow=1&username1=${username1}">上一页</a>
						</c:when>
					</c:choose>
					<c:choose>
						<c:when test="${page.totalPageCount==0}">
							<a href="usersearch.do?pageNow=${page.pageNow}&username1=${username1}">下一页</a>
						</c:when>
						<c:when test="${page.pageNow + 1 < page.totalPageCount}">
							<a href="usersearch.do?pageNow=${page.pageNow + 1}&username1=${username1}">下一页</a>
						</c:when>
						<c:when test="${page.pageNow + 1 >= page.totalPageCount}">
							<a href="usersearch.do?pageNow=${page.totalPageCount}&username1=${username1}">下一页</a>
						</c:when>
					</c:choose>
					<c:choose>
						<c:when test="${page.totalPageCount==0}">
							<a href="usersearch.do?pageNow=${page.pageNow}&username1=${username1}">尾页</a>
						</c:when>
						<c:otherwise>
							<a href="usersearch.do?pageNow=${page.totalPageCount}&username1=${username1}">尾页</a>
						</c:otherwise>
					</c:choose>
				</div>
			</table>
