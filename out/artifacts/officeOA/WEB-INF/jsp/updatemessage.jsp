...
<script type="text/javascript">
	function fanhui() {
		location.href = "message_management.do";
	}
</script>
...
<body>
	...
	<form class="form form-horizontal" id="form-article-add"
		action="updateMessages.do" method="post">
		<input type="hidden" value="${updatemessage.t_message_id}"
			id="messageid" name="messageid">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"
					value="${updatemessage.t_message_title}" id="messagetitle"
					name="messagetitle">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="messagecontent" name="messagecontent" cols="" rows=""
					class="textarea" onKeyUp="$.Huitextarealength(this,100)">${updatemessage.t_message_content}</textarea>
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box"> <select id="messagetype"
					...
					style="appearance: none; -moz-appearance: none; -webkit-appearance: none; -ms-appearance: none;">
						<option value="${messagetypeid }">${messagetypename}</option>
						<optgroup
							label="温馨提示：本次修改的消息类型——${messagetypename},如确需要修改，请在下面重新选择"></optgroup>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" value="${updatemessage.t_message_begintime}"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" value="${updatemessage.t_message_endtime}"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box"> <select id="ifpublish"
					...
					style="appearance: none; -moz-appearance: none; -webkit-appearance: none; -ms-appearance: none;">
						<option>${updatemessage.t_message_ifpublish}</option>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input class="btn btn-primary radius" type="submit"
					value="&nbsp;&nbsp;确认修改&nbsp;&nbsp;">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
					class="btn btn-primary radius" type="reset" onclick="fanhui()"
					value="&nbsp;&nbsp;返回&nbsp;&nbsp;">
			</div>
		</div>
	</form>
